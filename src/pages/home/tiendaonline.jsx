    ...
    >
      ...
      <motion.div
        ...
        style={{ 
          width: "1567.8px", 
          height: "519.61px",
          overflow: "visible" // ✅ FIXED - No clipping!
        }}
      >
        {/* LEFT TEXT AREA */}
        ...
        {/* ✅ TRUCK IMAGE - PERFECT POSITIONING (Matches your screenshot) */}
        <motion.div
          ...
          className="absolute -right-4 -bottom-4" // ✅ Exact position from your screenshot
          style={{ zIndex: 5 }}
        >
          <img 
            src={car2} 
